...
<body>
    <div class="sidebar">
        <div class="sidebar-brand">
            <img class="sidebar-brand-picture" src="logo.png" alt="Profile Picture">
                        ...
                        <tbody>
                            ...
                            @foreach ($orders as $p)
                                ...
                                <tr class="hidden-row" style="background-color: #F6F8FB;">
                                    <td colspan="4">
                                        @if ($p->orderType == 'Cuci Kering' || $p->orderType == 'Cuci Kering Setrika')
                                            <div class="row row-expand-1" style="margin-top:5px">
                                                ...
                                                {{-- <div class="row row-1">
                                                    <div class="col-md-2" style="text-align: center">
                                                        <img class="vector" src="{{ URL('image/Vector.png') }}"
                                                            alt="">
                                                        <br>
                                                    ...
                                                    <div class="col-md-2" style="text-align: center">
                                                        <img class="expand-image"
                                                            src="{{ URL('image/WashingMachine.png') }}" alt=""
                                                            style="margin-bottom:13px">
                                                        <br>

                                                    </div>
                                                    <div class="col-md-2" style="text-align: center">
                                                        <img class="iron" src="{{ URL('image/Iron.png') }}"
                                                            alt="">
                                                        <br>
                                                    </div>
                                                    <div class="col-md-2" style="text-align: center">
                                                        <img class="expand-image" src="{{ URL('image/Clothes.png') }}"
                                                            alt="">
                                                        <br>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row row-3" style="margin-top:5px">
                                                    <div class="col-md-2" style="text-align: center">
                                                        <button class="button myButton"
                                                            onclick="changeButton(this)">Next</button>
                                                ...
                                                <div class="col-md-1" style="text-align:center; flex-direction:column">
                                                    ...
                                                    <div class="row row-button">
                                                        <div class="content" style="flex-grow:1">
                                                            <button class="received-button">Done</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-1" style="text-align:center; flex-direction:column">
                                                    ...
                                                    <div class="row row-button">
                                                        <div class="content" style="flex-grow:1">
                                                            <form action="/test/iron" method="post"
                                                                class="readyFrom">
                                                                @csrf
                                                                <button type="submit" class="button myButton"
                                                                    data-column="iron">Next</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-1"
                                                    ...
                                                    <div class="row row-button">
                                                        <div class="content" style="flex-grow:1">
                                                            <form action="/store-database" method="post"
                                                                class="readyFrom">
                                                                @csrf
                                                                <input type="number" name="dateReady">
                                                                <button type="submit" class="button myButton"
                                                                    data-column="ready">Next</button>
                                        ...
                                        @elseif ($p->orderType == 'Cuci Basah')
                                            <div class="row row-expand-2" style="margin-top:5px">
                                                ...
                                                {{-- <div class="row row-4">
                                                    ...
                                                    <div class="col-md-2" style="text-align: center">
                                                        <img class="expand-image"
                                                            src="{{ URL('image/WashingMachine.png') }}"
                                                            alt="" style="margin-bottom:13px">
                                                        <br>
                                                    </div>
                                                    <div class="col-md-2" style="text-align: center">
                                                        <img class="expand-image"
                                                            src="{{ URL('image/Clothes.png') }}" alt="">
                                                        <br>
                                                    </div>
                                                </div>
